...
function loadModsFromJson() {
  Promise.all([
    fetch('https://raw.githubusercontent.com/PianetaSimTS/PianetaSim/refs/heads/main/Json/mods18.json').then(r => r.json()),
